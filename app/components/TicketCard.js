  ...
  return (
    <div className="flex border rounded-lg shadow p-4 space-x-4 bg-white">
      ...
      <div className="flex-1">
        <h2 className="text-lg font-bold">{ticket.section}</h2>
        ...
        <div className="space-y-1 text-sm mt-2">
          ...
          {ticket.obstructedView && (
            <p>Limited or obstructed view (printed on ticket)</p>
          )}
          {ticket.standingOnly && <p>Standing room only (SRO)</p>}
          {ticket.oneOfTheBest && (
      ...
      <div className="flex flex-col items-end">
        <p className="text-xl font-semibold">${ticket.currentPrice.toLocaleString()}</p>
